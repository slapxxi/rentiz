...
export const Footer = () => {
  return (
    <footer className="z-10 col-[wide] mt-10 grid grid-cols-subgrid bg-darknavy-800">
      <div className="col-[main] grid grid-cols-2 md:grid-cols-[minmax(auto,340px)_repeat(auto-fit,minmax(140px,1fr))] gap-10 py-10">
        <div className="grid gap-8 auto-rows-min col-span-full md:col-auto">
          ...
          <div className="flex gap-4">
            <FacebookIcon className="text-fluid-lg text-darknavy-600" />
            <InstagramIcon className="text-fluid-lg text-darknavy-600" />
            <TwitterIcon className="text-fluid-lg text-darknavy-600" />
            <YoutubeIcon className="text-fluid-lg text-darknavy-600" />
          </div>
        </div>
        ...
        {config.sections.map((section, i) => (
          ...
          >
            <h3 className="text-fluid-2xl font-semibold">{section.title}</h3>
            <ul className="grid gap-4">
              {section.links.map((link, i) => (
                <li key={i}>
                  <a href="#" className="text-fluid-lg text-neutral-300">
                    {link}
                  </a>
                </li>
              ))}
      ...
      <div className="col-[wide] grid grid-cols-subgrid border-t border-darknavy-700 text-fluid-lg text-neutral-300">
